...
export class CreateUserDto {
  ...
  @ApiProperty({
    ...
    oneOf: [{ $ref: getSchemaPath(UserConfig) }],
  })
  config?: UserConfig;

  @ApiProperty({
    description: '默认密码，服务端进行md5加密',
    example: '000000',
    default: '000000',
  })
  password: string;
...
export class CreateHabitDto {
  ...
  @ApiProperty({
    description: '上传后自动复制图片地址类型，支持：url、markdown',
    example: 'url',
  })
  pasteStyle: string;
